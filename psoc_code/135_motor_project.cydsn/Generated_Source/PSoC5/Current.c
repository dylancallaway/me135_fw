...
*
* \funcusage
*  \snippet Current_SUT.c usage_Current_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Current_SUT.c usage_Current_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Current_SUT.c usage_Current_Read  
*******************************************************************************/
...
* preferred Current_Read() API because the 
* Current_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Current_SUT.c usage_Current_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Current_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Current_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Current_0_INTR       (First pin in the list)
    *  - Current_1_INTR       (Second pin in the list)
    *  - ...
    *  - Current_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Current_SUT.c usage_Current_SetInterruptMode
    *******************************************************************************/
    void Current_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Current_0_INTR) != 0u) 
		{ 
			 Current_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Current_SUT.c usage_Current_ClearInterrupt
    *******************************************************************************/
