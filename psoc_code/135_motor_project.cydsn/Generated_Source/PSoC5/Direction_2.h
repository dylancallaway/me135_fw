...
void    Direction_2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Direction_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Direction_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Direction_2_SetInterruptMode() function.
     *  @{
     */
        #define Direction_2_INTR_NONE      (uint16)(0x0000u)
        #define Direction_2_INTR_RISING    (uint16)(0x0001u)
        #define Direction_2_INTR_FALLING   (uint16)(0x0002u)
        #define Direction_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Direction_2_INTR_MASK      (0x01u) 
#endif /* (Direction_2__INTSTAT) */
...
/* SIO registers */
#if defined(Direction_2__SIO_CFG)
    #define Direction_2_SIO_HYST_EN        (* (reg8 *) Direction_2__SIO_HYST_EN)
    #define Direction_2_SIO_REG_HIFREQ     (* (reg8 *) Direction_2__SIO_REG_HIFREQ)
    #define Direction_2_SIO_CFG            (* (reg8 *) Direction_2__SIO_CFG)
    #define Direction_2_SIO_DIFF           (* (reg8 *) Direction_2__SIO_DIFF)
#endif /* (Direction_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Direction_2_0_INTTYPE_REG 		(* (reg8 *) Direction_2__0__INTTYPE)
#endif /* (Direction_2__INTSTAT) */
