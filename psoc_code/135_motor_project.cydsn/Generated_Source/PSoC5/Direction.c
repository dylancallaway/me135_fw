...
{
    uint8 staticBits = (Direction_DR & (uint8)(~Direction_MASK));
    Direction_DR = staticBits | ((uint8)(value << Direction_SHIFT) & Direction_MASK);
}
...
{
	CyPins_SetPinDriveMode(Direction_0, mode);
}
...
{
    return (Direction_PS & Direction_MASK) >> Direction_SHIFT;
}
...
{
    return (Direction_DR & Direction_MASK) >> Direction_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Direction_0_INTR) != 0u) 
		{ 
			 Direction_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Direction_INTSTAT & Direction_MASK) >> Direction_SHIFT;
    }
