...
{
    uint8 staticBits = (Sleep_DR & (uint8)(~Sleep_MASK));
    Sleep_DR = staticBits | ((uint8)(value << Sleep_SHIFT) & Sleep_MASK);
}
...
{
	CyPins_SetPinDriveMode(Sleep_0, mode);
}
...
{
    return (Sleep_PS & Sleep_MASK) >> Sleep_SHIFT;
}
...
{
    return (Sleep_DR & Sleep_MASK) >> Sleep_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Sleep_0_INTR) != 0u) 
		{ 
			 Sleep_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Sleep_INTSTAT & Sleep_MASK) >> Sleep_SHIFT;
    }
