...
volatile uint8  EZI2C_rwOffsetS1; /* Current offset within buffer 1 */
volatile uint8  EZI2C_rwIndexS1;  /* Current index within buffer 1 */
...
/* Secondary slave address variables */
    ...
    volatile uint8 EZI2C_rwOffsetS2; /* Current offset within buffer 2 */
    volatile uint8 EZI2C_rwIndexS2;  /* Current index within buffer 2 */
