...
*
* \funcusage
*  \snippet Direction_1_SUT.c usage_Direction_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Direction_1_SUT.c usage_Direction_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Direction_1_SUT.c usage_Direction_1_Read  
*******************************************************************************/
...
* preferred Direction_1_Read() API because the 
* Direction_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Direction_1_SUT.c usage_Direction_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Direction_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Direction_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Direction_1_0_INTR       (First pin in the list)
    *  - Direction_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - Direction_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Direction_1_SUT.c usage_Direction_1_SetInterruptMode
    *******************************************************************************/
    void Direction_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Direction_1_0_INTR) != 0u) 
		{ 
			 Direction_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Direction_1_SUT.c usage_Direction_1_ClearInterrupt
    *******************************************************************************/
