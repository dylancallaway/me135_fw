// ======================================================================
// 135_motor_project.v generated from TopDesign.cysch
// 05/03/2019 at 13:16
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3ae61621-7ec2-4db7-9bd2-4fef7f64f82c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam Control_Reg_6.BusDisplay = 0;
    defparam Control_Reg_6.ExtrReset = 0;
    defparam Control_Reg_6.NumOutputs = 1;
	...
	wire [0:0] tmpOE__Heartbeat_net;
	wire [0:0] tmpFB_0__Heartbeat_net;
	wire [0:0] tmpIO_0__Heartbeat_net;
	wire [0:0] tmpINTERRUPT_0__Heartbeat_net;
	electrical [0:0] tmpSIOVREF__Heartbeat_net;

	cy_psoc3_pins_v1_10
		#(.id("779d251a-2a39-4797-90d9-6f7acf57a109"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Heartbeat
		 (.oe(tmpOE__Heartbeat_net),
		  .y({Net_2162}),
		  .fb({tmpFB_0__Heartbeat_net[0:0]}),
		  .io({tmpIO_0__Heartbeat_net[0:0]}),
		  .siovref(tmpSIOVREF__Heartbeat_net),
		  .interrupt({tmpINTERRUPT_0__Heartbeat_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Heartbeat_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Control_Reg_5.BusDisplay = 0;
    defparam Control_Reg_5.ExtrReset = 0;
    defparam Control_Reg_5.NumOutputs = 1;

	wire [0:0] tmpOE__Direction_2_net;
	wire [0:0] tmpFB_0__Direction_2_net;
	wire [0:0] tmpIO_0__Direction_2_net;
	wire [0:0] tmpINTERRUPT_0__Direction_2_net;
	electrical [0:0] tmpSIOVREF__Direction_2_net;

	cy_psoc3_pins_v1_10
		#(.id("7e835bf4-8964-4707-9c71-5540ec32c599"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Direction_2
		 (.oe(tmpOE__Direction_2_net),
		  .y({Net_870}),
		  .fb({tmpFB_0__Direction_2_net[0:0]}),
		  .io({tmpIO_0__Direction_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Direction_2_net),
		  .interrupt({tmpINTERRUPT_0__Direction_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Direction_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1a05881a-0a70-4723-8db8-8608094a0b85"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Sleep2_net;
	wire [0:0] tmpFB_0__Sleep2_net;
	wire [0:0] tmpIO_0__Sleep2_net;
	wire [0:0] tmpINTERRUPT_0__Sleep2_net;
	electrical [0:0] tmpSIOVREF__Sleep2_net;

	cy_psoc3_pins_v1_10
		#(.id("309bd952-b9a4-40cf-b9fb-b6aaaf65e600"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sleep2
		 (.oe(tmpOE__Sleep2_net),
		  .y({Net_1079}),
		  .fb({tmpFB_0__Sleep2_net[0:0]}),
		  .io({tmpIO_0__Sleep2_net[0:0]}),
		  .siovref(tmpSIOVREF__Sleep2_net),
		  .interrupt({tmpINTERRUPT_0__Sleep2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sleep2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_0 UART (
        ...
        .reset(1'b0),
        .rx(Net_1027),
        .tx_interrupt(Net_1039),
        .rx_interrupt(Net_2199),
        .tx_data(Net_1041),
        .tx_clk(Net_1042),
        .rx_data(Net_1043),
        .rx_clk(Net_1044));
	...
	wire [0:0] tmpOE__Sleep1_net;
	wire [0:0] tmpFB_0__Sleep1_net;
	wire [0:0] tmpIO_0__Sleep1_net;
	wire [0:0] tmpINTERRUPT_0__Sleep1_net;
	electrical [0:0] tmpSIOVREF__Sleep1_net;

	cy_psoc3_pins_v1_10
		#(.id("12c80992-7f7f-4b6e-9026-dc9b0f1726af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sleep1
		 (.oe(tmpOE__Sleep1_net),
		  .y({Net_1079}),
		  .fb({tmpFB_0__Sleep1_net[0:0]}),
		  .io({tmpIO_0__Sleep1_net[0:0]}),
		  .siovref(tmpSIOVREF__Sleep1_net),
		  .interrupt({tmpINTERRUPT_0__Sleep1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sleep1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Control_Reg_4.BusDisplay = 0;
    defparam Control_Reg_4.ExtrReset = 0;
    defparam Control_Reg_4.NumOutputs = 1;
	...
	cy_clock_v1_0
		#(.id("dc5d33b2-6108-4411-8b2f-ad315c62941d"),
		  .source_clock_id(""),
		  .divisor(0),
