...
*
* \funcusage
*  \snippet Direction_2_SUT.c usage_Direction_2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Direction_2_SUT.c usage_Direction_2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Direction_2_SUT.c usage_Direction_2_Read  
*******************************************************************************/
...
* preferred Direction_2_Read() API because the 
* Direction_2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Direction_2_SUT.c usage_Direction_2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Direction_2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Direction_2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Direction_2_0_INTR       (First pin in the list)
    *  - Direction_2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Direction_2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Direction_2_SUT.c usage_Direction_2_SetInterruptMode
    *******************************************************************************/
    void Direction_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Direction_2_0_INTR) != 0u) 
		{ 
			 Direction_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Direction_2_SUT.c usage_Direction_2_ClearInterrupt
    *******************************************************************************/
