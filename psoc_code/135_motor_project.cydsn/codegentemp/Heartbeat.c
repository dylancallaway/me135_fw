...
*
* \funcusage
*  \snippet Heartbeat_SUT.c usage_Heartbeat_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Heartbeat_SUT.c usage_Heartbeat_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Heartbeat_SUT.c usage_Heartbeat_Read  
*******************************************************************************/
...
* preferred Heartbeat_Read() API because the 
* Heartbeat_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Heartbeat_SUT.c usage_Heartbeat_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    *  component. Or you may use Heartbeat_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Heartbeat_0_INTR       (First pin in the list)
    *  - Heartbeat_1_INTR       (Second pin in the list)
    *  - ...
    *  - Heartbeat_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Heartbeat_SUT.c usage_Heartbeat_SetInterruptMode
    *******************************************************************************/
    void Heartbeat_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Heartbeat_0_INTR) != 0u) 
		{ 
			 Heartbeat_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Heartbeat_SUT.c usage_Heartbeat_ClearInterrupt
    *******************************************************************************/
